...
var DetailComponent = /** @class */ (function () {
    function DetailComponent(route, router, authenticationService, alertService) {
        ...
        this.loading = false;
        this.benefitPer10kColumns = ['type', 'tax', 'card', 'total'];
...
var SalaryComponent = /** @class */ (function () {
    ...
    SalaryComponent.prototype.onSubmit = function () {
        ...
        this.loading = true;
        this.authenticationService.getSummary(this.currentUser.userid, this.f.total_salary) //, this.f.password.value)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["first"])())
            .subscribe(function (data) {
            console.log(data);
            _this.loading = false;
